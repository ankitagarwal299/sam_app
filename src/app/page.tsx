...
export default function LandingPage() {
  ...
  // Manual injection of Vendor 360 Module
  const vendor360Module: ModuleData = {
    id: 'vendor-360-module-001',
    moduleName: 'Vendor 360° View',
    moduleDescription: 'Comprehensive view of purchases, renewals, financials, and relationships for vendors.',
    moduleImagePath: '',
    moduleUri: '/home/vendor-360',
    moduleIsDisabled: false,
    moduleIsHeight: false,
    modulePositionSequence: 100,
  };

  if (modules && !modules.find(m => m.moduleName === 'Vendor 360° View')) {
    modules.push(vendor360Module);
  }
  ...
  const getIcon = (name: string) => {
    ...
    if (name.includes('Vendor 360')) return <PieChart className="h-8 w-8 text-indigo-500" />;
